<?php
    ...
    if (isset($_POST['c'])) {
        ...
        $sqlValidacion = "SELECT * FROM invitacion WHERE codigo_unico = '$cadena'";
        ...
        $sql = "SELECT * FROM invitacion WHERE codigo_unico = '$cadena' AND checkin = 1";
