...
<head>
  ...
  <title>Reporte registrados | http://localhost/invitacionesQR/eventos/escaner.php?id=1</title>
...
<body onload="saveAsistente()">
    ...
    <div class="container">
      <div class="navbar-container">
        <div class="nav-links-left">
          ...
          <a href="index.php" class="nav-link-custom"><i class="bi bi-list-columns"></i> <span>Reporte general</span></a>
          <a href="registrados.php" class="nav-link-custom nav-link-active"><i class="bi bi-check-circle-fill text-success"></i> <span>Registrados</span></a>
      ...
      <div class="card-reporte">
        ...
        <div class="header-reporte">
          <div class="header-title">
            <h3><i class="bi bi-check-circle-fill"></i> Reporte de invitados registrados</h3>
          </div>
          <div class="header-controls">
            <input class="search-input" id="myInput" type="search" placeholder="🔍 Buscar por nombre, email..." aria-label="Search">
            <a href="reporteRegistrados.php" class="btn-excel"><i class="bi bi-file-earmark-excel-fill"></i> Excel</a>
          </div>
        </div>
  ...
  <footer class="footer-elegant">
    <div class="container">
      <div class="row g-3 align-items-center">
        <div class="col-md-4">
          <div class="footer-brand mb-1">
            <i class="bi bi-award-fill me-2"></i>scannCore
          </div>
          <p class="small" style="color:#94a3b8;">Sistema de gestión de invitados · INJUVENTUD GODEZAC</p>
        </div>
      ...
      <div class="footer-bottom text-center mt-3">
        <p class="mb-0"><i class="bi bi-shield-check me-1"></i> Sistema de gestión de invitados · Reporte de registrados</p>
      </div>
    </div>
  </footer>
  ...
  <script>
    // FUNCIÓN ORIGINAL COMPLETAMENTE PRESERVADA
    function saveAsistente(){
        $.ajax({
            type:"POST",
            url:"tablaInvitadosRegistrados.php",
            dataType: "html",
    ...
    // BÚSQUEDA EN TIEMPO REAL (preservada)
    ...
    // Función guardarEditar (debe existir en script.js)
