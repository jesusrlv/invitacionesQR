...
<head>
  ...
  <title>Reporte no registrados | </title>
...
<body onload="saveAsistente()">
    ...
    <div class="container">
      <div class="navbar-container">
        <div class="nav-links-left">
          ...
          <a href="noRegistrados.php" class="nav-link-custom nav-link-active"><i class="bi bi-x-circle-fill text-danger"></i> <span>No registrados</span></a>
      ...
      <div class="card-reporte">
        ...
        <div class="header-reporte">
          <div class="header-title">
            <h3><i class="bi bi-x-circle-fill"></i> Reporte de invitados no registrados</h3>
          </div>
          <div class="header-controls">
            <input class="search-input" id="myInput" type="search" placeholder="🔍 Buscar por nombre, email..." aria-label="Search">
            <a href="reporteNoRegistrados.php" class="btn-excel"><i class="bi bi-file-earmark-excel-fill"></i> Excel</a>
          </div>
        </div>
    ...
    <div class="container">
      <div class="row g-3 align-items-center">
        <div class="col-md-4">
          ...
          <p class="small" style="color:#94a3b8;">INJUVENTUD GODEZAC</p>
        </div>
      ...
      <div class="footer-bottom text-center mt-3">
        <p class="mb-0"><i class="bi bi-shield-check me-1"></i> Sistema de gestión de invitados · Reporte de no registrados</p>
      </div>
    </div>
  </footer>
  ...
  <script>
    ...
    function saveAsistente(){
        $.ajax({
            type:"POST",
            url:"tablaInvitadosNoRegistrados.php",
            dataType: "html",
